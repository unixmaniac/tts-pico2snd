 ...
 *
 *   original: pico2wave.c - Convert text to .wav using svox text-to-speech system.
 *   
 *   This file is modified to use pulseaudio as output.
 *
 */
...
int main(int argc, const char *argv[]) {
    ...
    ss.channels = 1;
    ss.rate = 16000;
    s = pa_simple_new (NULL, "PicoTTS", PA_STREAM_PLAYBACK, NULL, "TTS", &ss, NULL, NULL, NULL);
    ...
    */
    ...
    while (text_remaining) {
        ...
        do {
			...
			pa_simple_write(s, buffer, bufferSize, NULL);
                    done = TRUE;
